function [t, y] = mieulerimp(fname, a, b, ya, n)
%Método de Euler implícito para el problema de ecuacion diferencial 
...
y = zeros (n, 1); y(1) = ya;
for k = 1:(n-1)
    yaux = y(k) + h*feval(fname, t(k), y(k));
    y(k+1)= y(k) + h*feval(fname, t(k), yaux);
end
