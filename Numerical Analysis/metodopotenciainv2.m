function [lambdavec,lambda, v] = metodopotenciainv2(A, mu)
% Método de la potencia inversa para aproximar el valor propio dominante de la
...
[n,m] = size(A);
 ...
 while( tolvar > tol  && tolvec > tol && k < maxk)
     v1 = (A-mu*eye(n))\v;               % multiplicación matriz vector
