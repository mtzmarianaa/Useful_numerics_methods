...
% lambda.- vector en R^m con la aproximacion al multiplicador
%          de Lagrange asociado a la restriccion de igualdad.
% mu.- vector en R^p con la aproximacion al multiplicador
%          de Lagrange asociado a la restriccion de desigualdad.
% z.- vector en R^p con la variable de holgura en la restriccion
%     de desigualdad.
%---------------------------------------------------------------------------
...
m = length(b);     % numero de restricciones de igualdad
